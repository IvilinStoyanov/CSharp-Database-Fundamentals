...
namespace P03_FootballBetting.Data.Migrations
{
    ...
    [Migration("20180713111238_StartUp")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("P03_FootballBetting.Country", b =>
                {
            ...
            modelBuilder.Entity("P03_FootballBetting.Data.Models.Bet", b =>
                {
                    ...
                    b.Property<DateTime>("DateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 7, 13, 14, 12, 37, 702, DateTimeKind.Local));
            ...
            modelBuilder.Entity("P03_FootballBetting.Data.Models.Game", b =>
                {
                    ...
                    b.Property<int?>("PlayerStatisticGameId");

                    b.Property<int?>("PlayerStatisticPlayerId");
            ...
            modelBuilder.Entity("P03_FootballBetting.Data.Models.Town", b =>
                {
                    ...
                    b.HasAlternateKey("Name", "CountryId");
            ...
            modelBuilder.Entity("P03_FootballBetting.Data.Models.Game", b =>
                {
                    ...
                    b.HasOne("P03_FootballBetting.Data.Models.PlayerStatistic")
                        .WithMany("Games")
            ...
            modelBuilder.Entity("P03_FootballBetting.Data.Models.Town", b =>
                {
                    b.HasOne("P03_FootballBetting.Country", "Country")
                        .WithMany("Towns")
