        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Positions_Name", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Towns_Name_CountryId", x => new { x.Name, x.CountryId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Initials = table.Column<string>(type: "NCHAR(3)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateTime = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2018, 7, 13, 14, 12, 37, 702, DateTimeKind.Local)),
                    UserId = table.Column<int>(nullable: false),
